...
public class NewsService extends MappingJackson2HttpMessageConverter {
    ...
    private static String API_KEY = "abdaa3db069b45d194ee8cda55fefbb5"; // this is my private NewsAPI Key replace this for future use
    ...
    public static List<Example> sendRefinedUpdate(String country, String category, String source123) throws IOException {
        ...
        String urlString = "https://newsapi.org/v2/top-headlines?apiKey=" + API_KEY + "&country=" + country + "&category=" + category + "&source=" + source123 + "";
    ...
    public static List<Example> sendCategorizedUpdate(String country, String category) throws IOException {
        ...
        String urlString = "https://newsapi.org/v2/top-headlines?apiKey=" + API_KEY + "&country=" + country + "&category=" + category + "";
    ...
    public static List<Example> searchFor(String query) throws IOException {
    ...
    public static List<Example> newsGetTechnologyFor() throws IOException {
        final String country = "us";

        String urlString = "https://newsapi.org/v2/top-headlines?country=" + country + "&category=technology&apiKey=" + API_KEY;
    ...
    public static List<Example> newsGetEntertainmentFor() throws IOException {
        final String country = "us";

        String urlString = "https://newsapi.org/v2/top-headlines?country=" + country + "&category=entertainment&apiKey=" + API_KEY;
    ...
    public static List<Example> newsGetGeneralFor() throws IOException {
        final String country = "us";

        String urlString = "https://newsapi.org/v2/top-headlines?country=" + country + "&category=general&apiKey=" + API_KEY;
    ...
    public static List<Example> newsGetHealthFor() throws IOException {
        final String country = "us";

        String urlString = "https://newsapi.org/v2/top-headlines?country=" + country + "&category=health&apiKey=" + API_KEY;
    ...
    public static List<Example> newsGetScienceFor() throws IOException {
        final String country = "us";

        String urlString = "https://newsapi.org/v2/top-headlines?country=" + country + "&category=science&apiKey=" + API_KEY;
    ...
    public static List<Example> newsGetSportsFor() throws IOException {
        final String country = "us";

        String urlString = "https://newsapi.org/v2/top-headlines?country=" + country + "&category=sports&apiKey=" + API_KEY;
	...
	public static List<Example> newsGetBusinessFor() throws IOException {
		final String country = "us";

		String urlString = "https://newsapi.org/v2/top-headlines?country=" + country + "&category=business&apiKey=" + API_KEY;
